...
impl Camera{
    pub fn new(device: &wgpu::Device, origin: Vec3, look_at: Vec3, view_up: Vec3, fov: f32, aspect: f32, near: f32, far: f32, aperture: f32, focus_dist: f32,) -> Self {
        ...
        let controller = CameraController::new(1.0,0.3);
...
impl CameraController{
    ...
    pub fn process_keyboard(&mut self, key: KeyCode, state: ElementState) -> bool{
        let amount = if state == ElementState::Pressed {0.01} else {0.0};
    ...
    pub fn process_mouse(&mut self, mouse_dx: f64, mouse_dy: f64){
        self.rotate_horizontal = mouse_dx as f32 * 0.02;
        self.rotate_vertical = mouse_dy as f32 * 0.02;
    }
