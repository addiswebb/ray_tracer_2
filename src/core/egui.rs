    ...
    pub fn render_ui(&mut self, ctx: &mut UiContext) {
        ...
        egui::SidePanel::right("Inspector")
            ...
            .show(self.context(), |ui| {
                ...
                ui.add(egui::Slider::new(&mut params.number_of_bounces, 0..=100).text("Bounces"));
                ui.add(
                    egui::Slider::new(&mut params.rays_per_pixel, 0..=100).text("Rays Per Pixel"),
                );
                ui.horizontal(|ui| {
                ...
                ui.horizontal(|ui| {
                    ui.label("Scene ID");
                    ui.add(
                        egui::DragValue::new(&mut ctx.scene_manager.selected_scene).range(0..=5),
                    );
                });
                if ctx.scene_manager.selected_entity != -1 {
                        ...
                        < ctx.scene_manager.scene.spheres.len() as i32
                    {
                        ...
                        ui.horizontal(|ui| {
                            ui.add(
                                egui::DragValue::new(&mut s.material.emission_color[0]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut s.material.emission_color[1]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut s.material.emission_color[2]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut s.material.emission_color[3]).speed(0.01),
                            );
                        ...
                        ui.horizontal(|ui| {
                            ui.add(
                                egui::DragValue::new(&mut s.material.emission_strength).speed(0.01),
                            );
                            ui.label(format!("Emission Strength"));
                        });
                        ui.horizontal(|ui| {
                            ui.add(
                                egui::DragValue::new(&mut s.material.specular_color[0]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut s.material.specular_color[1]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut s.material.specular_color[2]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut s.material.specular_color[3]).speed(0.01),
                            );
                        ...
                        ui.horizontal(|ui| {
                            ui.add(egui::DragValue::new(&mut s.material.smoothness).speed(0.01));
                        ...
                        let m =
                            &mut ctx.scene_manager.scene.meshes[ctx.scene_manager.selected_entity
                                as usize
                        ...
                        ui.horizontal(|ui| {
                            ui.add(
                                egui::DragValue::new(&mut m.material.emission_color[0]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut m.material.emission_color[1]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut m.material.emission_color[2]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut m.material.emission_color[3]).speed(0.01),
                            );
                            ui.label(format!("Emissive Color"));
                        });
                        ...
                        ui.horizontal(|ui| {
                            ui.add(
                                egui::DragValue::new(&mut m.material.emission_strength).speed(0.01),
                            );
                            ui.label(format!("Emission Strength"));
                        });
                        ui.horizontal(|ui| {
                            ui.add(
                                egui::DragValue::new(&mut m.material.specular_color[0]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut m.material.specular_color[1]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut m.material.specular_color[2]).speed(0.01),
                            );
                            ui.add(
                                egui::DragValue::new(&mut m.material.specular_color[3]).speed(0.01),
                            );
                            ui.label(format!("Specular Color"));
                        });
                        ui.horizontal(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ui.add(egui::DragValue::new(&mut m.material.smoothness).speed(0.01));
                            ui.label(format!("Smoothness"));
                        });
                        ui.horizontal(|ui| {
        ...
        egui::SidePanel::left("Debug")
            ...
            .show(self.context(), |ui| {
                ...
                ui.add(
                    egui::Slider::new(&mut params.debug_scale, 1..=1000).text("Depth Threshold"),
                );
                ui.separator();
